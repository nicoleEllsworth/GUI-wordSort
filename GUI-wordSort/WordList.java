...
public class WordList {
    ...
    public void printWordList() {
        if (wordList.size() == 0) {
            ...
            for (Word w : wordList) {
                ...
                System.out.println("Tags: " + w.getWordTags() +
                        " " + w.getIntRate());
    ...
    /**
     * returns word list formatted with tags and names
     *
     * @return String.
     */
    public String formatWordList() {
        String formatwordlist = "";
        if (wordList.size() == 0) {
            formatwordlist = "list is empty";
        } else {
            formatwordlist += ("Word list: \n");
            for (Word w : wordList) {
                formatwordlist += (w.getWordName() + "\n");
                formatwordlist += ("Tags: " + w.getWordTags() +
                        ", match score: " + w.getIntRate() + "\n");
                formatwordlist += ("\n");
            }
        }
